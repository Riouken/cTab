...
class cTab_UAV_dlg {
	idd = 1773;
	movingEnable = true;
	onLoad = "uiNamespace setVariable ['cTab_UAV_dlg', (_this select 0)];nul = [] execVM '\cTab\uav\ctab_gui_uav_onload.sqf';";
	onUnload = "_nop = [] call cTabUavDelCam;uiNamespace setVariable ['cTab_UAV_dlg', displayNull];call cTab_fnc_close;";
	...
	class controlsBackground {
			...
			class UAVMapBG: cTab_RscPicture
			{
				moving = 1;
				idc = 478594;
				text = "\cTab\img\window_2.jpg";
	...
	class controls {
			...
			class btnF1: cTab_RscButtonInv
			{
				...
				action = "_nop = [cTabIfOpen select 0,cTabIfOpen select 2,cTabIfOpen select 4] spawn cTab_load_BFT;";
			};
			...
			class btnMain: cTab_RscButtonInv
			{
				...
				h = 0.731482 * GUI_GRID_H;
				tooltip = "Main Menu";
				action = "['cTab_main_dlg',[['mode','DESKTOP']]] call cTab_fnc_settings;_ok = [cTabIfOpen select 0,cTabIfOpen select 2,cTabIfOpen select 4] execVM 'cTab\cTab_gui_start.sqf';";
			};
			class btnFN: cTab_RscButtonInv
			{
				...
				w = 0.683335 * GUI_GRID_W;
				h = 0.731482 * GUI_GRID_H;
				action = "['cTab_uav_dlg'] call cTab_fnc_iconText_toggle;";
			...
			class btnACT: cTab_RscButtonInv
			{
				...
				action = "nop = [] call cTabUavTakeControl;";
				tooltip = "View Optics";
			};
