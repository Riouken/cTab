...
class cTab_microDAGR_dsp
{
	...
	fadeIn = 0;
	fadeOut = 0;
	onLoad = "((_this select 0) displayCtrl 1200) ctrlSetText ('cTab_microDAGR_dsp' call cTab_fnc_getBackground);uiNamespace setVariable ['cTab_microDAGR_dsp', (_this select 0)];";
